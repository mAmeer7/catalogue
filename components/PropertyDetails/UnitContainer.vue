...
<template>
 ...
 :class="isPDF ? 'relative pdf-height bg-cover bg-center bg-no-repeat py-16 text-white' : 'relative lg:min-h-screen bg-cover bg-center bg-no-repeat py-10 lg:py-16 text-white'"
